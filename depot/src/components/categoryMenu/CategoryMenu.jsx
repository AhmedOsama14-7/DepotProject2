...
export default function CategoryMenu() {
    ...
    const [MobileCategoryBtnClicked , setMobileCategoryBtnClicked] = useState(false)
  ...
  return (
    <>
      ...
      <div className="categories">
        ...
        <input type="button" onClick={()=> pcCategoryBtnActive(Decoration)} className={activeCat ==Decoration ? "active" : "" } value="decoration" />
        <input type="button" onClick={()=> pcCategoryBtnActive(hardWoods)} className={activeCat == hardWoods ? "active" : "" } value="hardWoods" />
        <input type="button" onClick={()=> pcCategoryBtnActive(Fancies)} className={activeCat== Fancies ? "active" : "" } value="fancies" />
        </div>
      </div>
      </div>
